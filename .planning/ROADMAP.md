...
- [x] 07-02-PLAN.md — browse_feed_for_viewer DROP+CREATE: +city_name +finer distance +tuned soft-score (vibe COUNT + mutual-compat nudge) + e23 contract regression test (REQ-E22, REQ-E23)
- [x] 07-03-PLAN.md — withdraw_interest DEFINER RPC (deletes own plain interest, auth.uid() gate) + e24 SQL test (REQ-E24)
- [x] 07-08-PLAN.md — E25 archive: /my-nights upcoming/archive segment toggle (status bucketing) + test (REQ-E25)
...
| 7. Enhancements & Polish | 4/9 | In Progress|  |
